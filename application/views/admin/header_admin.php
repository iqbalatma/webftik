...
<head>
    ...
    <!-- Ionicons -->
    <link rel="stylesheet"
        href="<?= base_url();?>assets/AdminLTE-master/https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">
    <!-- Tempusdominus Bbootstrap 4 -->
    <link rel="stylesheet"
        href="<?= base_url();?>assets/AdminLTE-master/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css">
    <!-- iCheck -->
    <link rel="stylesheet"
        href="<?= base_url();?>assets/AdminLTE-master/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
    <!-- JQVMap -->
    ...
    <!-- overlayScrollbars -->
    <link rel="stylesheet"
        href="<?= base_url();?>assets/AdminLTE-master/plugins/overlayScrollbars/css/OverlayScrollbars.min.css">
    <!-- Daterange picker -->
