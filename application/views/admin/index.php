    ...
    <div class="wrapper">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <img src="<?= base_url();?>assets/AdminLTE-master/dist/img/user1-128x128.jpg"
                        ...
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <img src="<?= base_url();?>assets/AdminLTE-master/dist/img/user3-128x128.jpg"
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                <img src="<?= base_url();?>assets/AdminLTE-master/dist/img/AdminLTELogo.png" alt="AdminLTE Logo"
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="<?= base_url();?>assets/AdminLTE-master/dist/img/user2-160x160.jpg"
                                    ...
                                    <div class="direct-chat-messages">
                                        ...
                                        <div class="direct-chat-msg">
                                            ...
                                            <img class="direct-chat-img"
                                                src="<?= base_url();?>assets/AdminLTE-master/dist/img/user1-128x128.jpg"
                                        ...
                                        <div class="direct-chat-msg right">
                                            ...
                                            <!-- /.direct-chat-infos -->
                                            <img class="direct-chat-img"
                                                src="<?= base_url();?>assets/AdminLTE-master/dist/img/user3-128x128.jpg"
                                                alt="message user image">
                                            <!-- /.direct-chat-img -->
                                            <div class="direct-chat-text">
                                    ...
                                    <div class="direct-chat-contacts">
                                        <ul class="contacts-list">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img"
                                                        src="<?= base_url();?>assets/AdminLTE-master/dist/img/user7-128x128.jpg">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img"
                                                        src="<?= base_url();?>assets/AdminLTE-master/dist/img/user5-128x128.jpg">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img"
                                                        src="<?= base_url();?>assets/AdminLTE-master/dist/img/user6-128x128.jpg">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img"
                                                        src="<?= base_url();?>assets/AdminLTE-master/dist/img/user8-128x128.jpg">
